...
{
    // https://docs.edgegap.com/docs/sample-projects/fishnet-on-edgegap
    ...
    /// </summary>
    [SerializeField] private string AppName = "tbd";
    ...
    /// </summary>
    [SerializeField] private string AppVersion = "latest";
    ...
    /// </summary>
    [SerializeField] private string AuthHeaderValue = "token 0751f477-9e21-4a44-8e55-39a3be3c033c";
        ...
        while (!isServerReady)
        {
            ...
            if (_request.IsSuccessStatusCode)
            {
                ...
                if (isServerReady)
                {
                    ...
                    //Once the connection is complete the SceneManager will autoload the "OnlineScene".
